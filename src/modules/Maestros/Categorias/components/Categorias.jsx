...
export default function Categorias() {
    ...
    const { toggleStatus, isUpdating } = useDisableStatus(setCategorias);
    const { deleteData, isDeleting, deleteError } = useDeleteData(setCategorias);
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            setCategorias((prev) => [...prev, formattedRecord]);
            handleCloseModal();
        } catch (error) {
            Swal.fire({
                icon: 'error',
        ...
        <>
            ...
            <div>
                ...
                <div className="bg-white cont_principal">
                    <h1 className="ml-1 justify-between items-center font-semibold text-2xl" style={{ color: '#1c1c1c' }}>Gestión de <span style={{ color: '#b4bc00' }}>Categorías</span></h1>
                    <span className='text-sm ml-1 text-gray-600 mt-2'>Sección para gestionar la información de las categorías de la compañía</span>
                    <div className="contenedor-tabla">
                        ...
                        <ModalForm
                            ...
                            title={modalData ? 'Editar categoría' : 'Nueva categoría'}
